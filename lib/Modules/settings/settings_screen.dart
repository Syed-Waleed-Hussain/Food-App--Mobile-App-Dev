                    ...
                    child: Column(
                      children: [
                        ...
                        SwitchListTile(
                          ...
                          onChanged: (val) {
                            controller.toggleOrderNotifications(val);
                          },
                        ),
                        const Divider(height: 1),
                        SwitchListTile(
                          ...
                          value: controller.promoAlerts,
                          onChanged: (val) {
                            controller.togglePromoAlerts(val);
                          },
                        ),
                        const Divider(height: 1),
                        SwitchListTile(
                          ...
                          value: controller.soundEffects,
                          onChanged: (val) {
                            controller.toggleSoundEffects(val);
                          },
                        ),
                      ],
                    ),
